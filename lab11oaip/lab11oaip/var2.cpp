...
int countRightLeaves(Tree* t) {
	...
	count += countRightLeaves(t->Left) + countRightLeaves(t->Right);
	return count;
}
...
void main()
{
	...
	for (;;)
	{
		...
		case 6:
			cout << "\nКоличество правых листьев: " << countRightLeaves(Root) << endl;
			break;
